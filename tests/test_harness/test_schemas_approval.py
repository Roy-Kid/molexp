...
class TestSchemasApproval:
    # ---------------------------------------------------------- ApprovalIntent

    def test_approval_intent_carries_seven_values(self) -> None:
    ...
    def test_approval_request_with_metadata_round_trip(self) -> None:
        from molexp.harness.schemas.approval import ApprovalRequest
    ...
    def test_approval_request_is_frozen(self) -> None:
        req = _make_request()
        with pytest.raises(ValidationError):
            req.intent = "full_execution"  # type: ignore[misc]

    def test_approval_request_rejects_unknown_intent(self) -> None:
        from molexp.harness.schemas.approval import ApprovalRequest
    ...
    def test_approval_request_default_factory_independent(self) -> None:
        a = _make_request()
        b = _make_request()
    ...
    def test_approval_decision_round_trip(self) -> None:
        from molexp.harness.schemas.approval import ApprovalDecision
    ...
    def test_three_approval_types_re_exported_from_schemas_package(self) -> None:
