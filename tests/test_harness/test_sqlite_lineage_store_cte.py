...
def test_ac001_trace_backward_linear_chain_matches_reference_and_expected_order(
    store: SQLiteArtifactLineageStore, artifact_store: FileArtifactStore
) -> None:
...
def test_ac005_lineage_graph_diamond_shape_is_byte_identical_golden(
    ...
    expected_edges = [
        {"parent_id": a, "child_id": b, "relation": "derived_from", "stage": None, "run_id": None},
        {"parent_id": a, "child_id": c, "relation": "derived_from", "stage": None, "run_id": None},
        {"parent_id": b, "child_id": d, "relation": "derived_from", "stage": None, "run_id": None},
        {"parent_id": c, "child_id": d, "relation": "derived_from", "stage": None, "run_id": None},
    ]
