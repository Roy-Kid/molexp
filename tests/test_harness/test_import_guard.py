...
def test_harness_agent_imports_target_only_the_router_module() -> None:
...
def test_harness_forbids_application_layers_statically() -> None:
...
def test_static_scan_detects_planted_violations(tmp_path: Path) -> None:
