...
from molexp.services.plan_runtime.persist import _compile_source_to_ir
...
def test_package_mode_compiles_ir_via_subprocess_and_annotates() -> None:
    ...
    stayed empty."""
    from molexp.services.plan_runtime.persist import _compile_package_to_ir
...
def test_package_mode_returns_none_on_broken_package() -> None:
    from molexp.harness.schemas import WorkflowSource
    from molexp.services.plan_runtime.persist import _compile_package_to_ir
