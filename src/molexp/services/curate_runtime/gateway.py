...
whose structured output is a :class:`~molexp.services.curate_runtime.flow.CurationInvocation`),
...
def curate_agent_responses() -> dict[str, type[BaseModel]]:
    ...
    from molexp.services.curate_runtime.flow import CurationInvocation
