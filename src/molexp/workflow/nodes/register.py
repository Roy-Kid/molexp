...
from ..plugin import NodeRegistry, NodeMetadata, PortMetadata
...
def register_builtin_nodes(registry: NodeRegistry) -> None:
    ...
    registry.register(
        ...
        metadata=NodeMetadata(
            ...
            inputs=[
                PortMetadata(name="content", type="string", description="Text content to write")
            ],
            outputs=[
                PortMetadata(name="path", type="string", description="Path to written file")
            ],
            icon="file-text",
            tags=["file", "write", "io"],
        )
    ...
    registry.register(
        ...
        metadata=NodeMetadata(
            ...
            inputs=[
                PortMetadata(name="input", type="string", description="File path or JSON string")
            ],
            outputs=[
    ...
    registry.register(
        ...
        metadata=NodeMetadata(
            ...
            inputs=[
                PortMetadata(name="data", type="object", description="Data to serialize")
            ],
            outputs=[
                PortMetadata(name="path", type="string", description="Path to written file")
            ],
    ...
    registry.register(
        ...
        metadata=NodeMetadata(
            ...
            inputs=[
                PortMetadata(name="body", type="string", description="Request body (optional)", required=False)
            ],
            outputs=[
                PortMetadata(name="response", type="object", description="HTTP response")
            ],
            icon="globe",
    ...
    registry.register(
        ...
        metadata=NodeMetadata(
            ...
            inputs=[
                PortMetadata(name="text", type="string", description="Input text")
            ],
            outputs=[
                PortMetadata(name="result", type="string", description="Transformed text")
            ],
            icon="type",
    ...
    registry.register(
        ...
        metadata=NodeMetadata(
            ...
            outputs=[
                PortMetadata(name="data", type="any", description="Same data (pass-through)")
            ],
            icon="bug",
